...
export function startDate(lastDays) {
  const today = new Date()
  const start_milliseconds = today.getTime() - lastDays * 60 * 60 * 24 * 1000

  const startDay = new Date()
  startDay.setTime(start_milliseconds)

  const strYear = startDay.getFullYear()
  let strDay = startDay.getDate()
  if (strDay < 10) {
    strDay = '0' + strDay
  }
...
export function endDate(nextDays) {
  const today = new Date()
  const start_milliseconds = today.getTime() + nextDays * 60 * 60 * 24 * 1000
...
export function startTime(lastDays) {
  const today = new Date()
  const start_milliseconds = today.getTime() - lastDays * 60 * 60 * 24 * 1000
...
export function endTime(nextDays) {
  const today = new Date()
  const start_milliseconds = today.getTime() + nextDays * 60 * 60 * 24 * 1000
